            ...
            <div className="relative h-64 overflow-hidden">
                <img
                    src={property.images && property.images.length > 0
                        ? (property.images[0].startsWith('http') ? property.images[0] : `${import.meta.env.VITE_BACKEND_URL || 'http://localhost:5000'}${property.images[0].startsWith('/') ? '' : '/'}${property.images[0]}`)
